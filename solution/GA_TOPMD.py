...
class GaTopMd:
    ...
    def run(self):
        population = self.PopulationObject.initializeTopMdGreed(self.initialChromossome,
        ...
        for g in range(self.generationSize):
            ...
            for i in range(len(population)):
                population[i] = self.mutationObject.insert_points_TOP_3(self.mensureCost,
            ...
            for cross in range(select_parents_index.size):
                ...
                if flag:
                    ...
                    a,b = self.crossoverObject.cross_slice(par_1,par_2,
                                                           self.mensureCost,
                                                                  self.start_point,
                                                                  self.end_point)
